...
- [~] T0002 @claude Add a real package-publish pipeline, so other hinolugi Javascript or web projects can depend on this library as an installed package:
...
- [ ] T0005 (needs T0002 T0003 A0004) Make a full release, including making the packages available via GitHub. 
