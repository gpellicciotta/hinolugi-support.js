...
- [~] T0001 cli-logging-utility @claude Add a shared CLI logging utility that is compliant with the guidelines and maximally API-similar to what is (being) implemented in hinolugi-support.java and hinolugi-support.python
- [ ] T0002 Add a real package-publish pipeline, so other hinolugi Javascript or web projects can depend on this library as an installed package:
...
- [ ] T0005 (needs T0001 T0002 T0003 A0004) Make a full release, including making the packages available via GitHub. 
